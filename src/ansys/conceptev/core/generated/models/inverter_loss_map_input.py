...
T = TypeVar("T", bound="InverterLossMapInput")


@_attrs_define
class InverterLossMapInput:
    """Inverter Loss Map Input."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if component_type != "InverterLossMap" and not isinstance(component_type, Unset):
            raise ValueError(
                f"component_type must match const 'InverterLossMap', got '{component_type}'"
            )
        ...
        alternative_voltage_drop = _parse_alternative_voltage_drop(
            d.pop("alternative_voltage_drop", UNSET)
        )
        ...
        inverter_loss_map_input.additional_properties = d
        return inverter_loss_map_input
