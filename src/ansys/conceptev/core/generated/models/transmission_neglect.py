...
T = TypeVar("T", bound="TransmissionNeglect")


@_attrs_define
class TransmissionNeglect:
    ...
    component_type: Literal["TransmissionNeglect"] | Unset = "TransmissionNeglect"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        component_type = cast(Literal["TransmissionNeglect"] | Unset, d.pop("component_type", UNSET))
        if component_type != "TransmissionNeglect" and not isinstance(component_type, Unset):
            raise ValueError(f"component_type must match const 'TransmissionNeglect', got '{component_type}'")

        transmission_neglect = cls(
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        transmission_neglect.additional_properties = d
        return transmission_neglect
