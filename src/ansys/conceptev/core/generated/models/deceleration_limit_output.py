...
T = TypeVar("T", bound="DecelerationLimitOutput")


@_attrs_define
class DecelerationLimitOutput:
    """Deceleration Limit Output."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if config_type != "deceleration_limit" and not isinstance(config_type, Unset):
            raise ValueError(
                f"config_type must match const 'deceleration_limit', got '{config_type}'"
            )
        ...
        deceleration_limit_output.additional_properties = d
        return deceleration_limit_output
