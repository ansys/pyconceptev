...
T = TypeVar("T", bound="DecelerationLimitInput")


@_attrs_define
class DecelerationLimitInput:
    """Deceleration Limit Input."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deceleration_limit_input.additional_properties = d
        return deceleration_limit_input
