...
T = TypeVar("T", bound="TransmissionLossMapDataInDB")


@_attrs_define
class TransmissionLossMapDataInDB:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transmission_loss_map_data_in_db = cls(
            gear_ratios=gear_ratios,
            speeds=speeds,
            torques=torques,
            losses=losses,
        ...
        transmission_loss_map_data_in_db.additional_properties = d
        return transmission_loss_map_data_in_db
