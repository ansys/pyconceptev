...
T = TypeVar("T", bound="MotorLossMapID")


@_attrs_define
class MotorLossMapID:
    ...
    component_type: Literal["MotorLossMapID"] | Unset = "MotorLossMapID"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        component_type = cast(Literal["MotorLossMapID"] | Unset, d.pop("component_type", UNSET))
        if component_type != "MotorLossMapID" and not isinstance(component_type, Unset):
            raise ValueError(f"component_type must match const 'MotorLossMapID', got '{component_type}'")

        motor_loss_map_id = cls(
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        motor_loss_map_id.additional_properties = d
        return motor_loss_map_id
