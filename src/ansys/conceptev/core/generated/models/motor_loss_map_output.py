...
T = TypeVar("T", bound="MotorLossMapOutput")


@_attrs_define
class MotorLossMapOutput:
    """Motor Loss Map Output."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if component_type != "MotorLossMap" and not isinstance(component_type, Unset):
            raise ValueError(
                f"component_type must match const 'MotorLossMap', got '{component_type}'"
            )
        ...
        motor_loss_map_output.additional_properties = d
        return motor_loss_map_output
