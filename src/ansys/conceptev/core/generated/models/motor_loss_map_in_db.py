...
T = TypeVar("T", bound="MotorLossMapInDB")


@_attrs_define
class MotorLossMapInDB:
    """Motor in Database."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        motor_loss_map_in_db.additional_properties = d
        return motor_loss_map_in_db
