...
T = TypeVar("T", bound="MotorTorqueCurvesID")
...
class MotorTorqueCurvesID:
    ...
    component_type: Literal["MotorTorqueCurveID"] | Unset = "MotorTorqueCurveID"
    voltages: list[float] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        voltages: list[float] | Unset = UNSET
        if not isinstance(self.voltages, Unset):
        ...
        if voltages is not UNSET:
            field_dict["voltages"] = voltages
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        component_type = cast(Literal["MotorTorqueCurveID"] | Unset, d.pop("component_type", UNSET))
        if component_type != "MotorTorqueCurveID" and not isinstance(component_type, Unset):
            raise ValueError(f"component_type must match const 'MotorTorqueCurveID', got '{component_type}'")

        voltages = cast(list[float], d.pop("voltages", UNSET))

        motor_torque_curves_id = cls(
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        motor_torque_curves_id.additional_properties = d
        return motor_torque_curves_id
