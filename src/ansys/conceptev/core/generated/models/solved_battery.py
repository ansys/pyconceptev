...
T = TypeVar("T", bound="SolvedBattery")
...
class SolvedBattery:
    ...
    solved_component_type: Literal["battery"] | Unset = "battery"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solved_component_type = cast(Literal["battery"] | Unset, d.pop("solved_component_type", UNSET))
        if solved_component_type != "battery" and not isinstance(solved_component_type, Unset):
            raise ValueError(f"solved_component_type must match const 'battery', got '{solved_component_type}'")
        ...
        solved_battery.additional_properties = d
        return solved_battery
