...
T = TypeVar("T", bound="TransmissionLossMapInput")


@_attrs_define
class TransmissionLossMapInput:
    """Transmission Loss Map Input."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        component_type = cast(
            Literal["TransmissionLossMap"] | Unset, d.pop("component_type", UNSET)
        )
        if component_type != "TransmissionLossMap" and not isinstance(component_type, Unset):
            raise ValueError(
                f"component_type must match const 'TransmissionLossMap', got '{component_type}'"
            )
        ...
        transmission_loss_map_input = cls(
            loss_map_data_id=loss_map_data_id,
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        transmission_loss_map_input.additional_properties = d
        return transmission_loss_map_input
