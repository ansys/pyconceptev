...
class SolvedRoad:
    ...
    solved_component_type: Literal["road"] | Unset = "road"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solved_component_type = cast(Literal["road"] | Unset, d.pop("solved_component_type", UNSET))
        if solved_component_type != "road" and not isinstance(solved_component_type, Unset):
            raise ValueError(f"solved_component_type must match const 'road', got '{solved_component_type}'")
        ...
        solved_road.additional_properties = d
        return solved_road
