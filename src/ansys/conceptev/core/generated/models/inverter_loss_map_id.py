...
T = TypeVar("T", bound="InverterLossMapID")


@_attrs_define
class InverterLossMapID:
    """Inverter Loss Map ID."""
    ...
    component_type: Literal["InverterLossMapID"] | Unset = "InverterLossMapID"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        component_type = cast(Literal["InverterLossMapID"] | Unset, d.pop("component_type", UNSET))
        if component_type != "InverterLossMapID" and not isinstance(component_type, Unset):
            raise ValueError(f"component_type must match const 'InverterLossMapID', got '{component_type}'")
        ...
        inverter_loss_map_id.additional_properties = d
        return inverter_loss_map_id
