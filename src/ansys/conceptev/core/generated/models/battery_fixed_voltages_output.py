...
T = TypeVar("T", bound="BatteryFixedVoltagesOutput")


@_attrs_define
class BatteryFixedVoltagesOutput:
    """Battery Fixed Voltages Output."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        battery_fixed_voltages_output = cls(
            id=id,
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        battery_fixed_voltages_output.additional_properties = d
        return battery_fixed_voltages_output
