...
T = TypeVar("T", bound="TransmissionLossCoefficientsOutput")


@_attrs_define
class TransmissionLossCoefficientsOutput:
    """Transmission Loss Coefficients Output."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transmission_loss_coefficients_output = cls(
            id=id,
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        transmission_loss_coefficients_output.additional_properties = d
        return transmission_loss_coefficients_output
