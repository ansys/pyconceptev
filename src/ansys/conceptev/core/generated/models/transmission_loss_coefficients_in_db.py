...
T = TypeVar("T", bound="TransmissionLossCoefficientsInDB")


@_attrs_define
class TransmissionLossCoefficientsInDB:
    """Transmission In DB."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transmission_loss_coefficients_in_db = cls(
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        transmission_loss_coefficients_in_db.additional_properties = d
        return transmission_loss_coefficients_in_db
