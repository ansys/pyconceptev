...
T = TypeVar("T", bound="InverterAnalyticalInput")


@_attrs_define
class InverterAnalyticalInput:
    """Inverter Analytical Input."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inverter_analytical_input.additional_properties = d
        return inverter_analytical_input
