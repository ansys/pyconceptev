...
T = TypeVar("T", bound="TotalTractiveTorqueGraph")


@_attrs_define
class TotalTractiveTorqueGraph:
    """Total Tractive Torque Graph."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        total_tractive_torque_graph = cls(
            speeds=speeds,
            acceleration=acceleration,
            total_tractive_torques=total_tractive_torques,
            aero_forces=aero_forces,
        ...
        return total_tractive_torque_graph
