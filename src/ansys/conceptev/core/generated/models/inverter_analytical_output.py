...
T = TypeVar("T", bound="InverterAnalyticalOutput")


@_attrs_define
class InverterAnalyticalOutput:
    """Inverter Analytical Output."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_inverter_data(
            data: object,
        ) -> InverterIGBTData | InverterMOSFETData | InverterSimpleData:
            try:
        ...
        if component_type != "InverterAnalytical" and not isinstance(component_type, Unset):
            raise ValueError(
                f"component_type must match const 'InverterAnalytical', got '{component_type}'"
            )
        ...
        inverter_analytical_output = cls(
            id=id,
            inverter_data=inverter_data,
            item_type=item_type,
            name=name,
        ...
        inverter_analytical_output.additional_properties = d
        return inverter_analytical_output
