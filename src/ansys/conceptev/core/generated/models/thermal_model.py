...
if TYPE_CHECKING:
    from ..models.thermal_model_loss_map import ThermalModelLossMap
    from ..models.thermal_model_temperature_map import ThermalModelTemperatureMap
    from ..models.thermal_network import ThermalNetwork


T = TypeVar("T", bound="ThermalModel")
...
class ThermalModel:
    ...
    loss_map: ThermalModelLossMap
    temperature_map: ThermalModelTemperatureMap
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        loss_map = ThermalModelLossMap.from_dict(d.pop("loss_map"))
