...
T = TypeVar("T", bound="TransmissionLossCoefficients")


@_attrs_define
class TransmissionLossCoefficients:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transmission_loss_coefficients = cls(
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        transmission_loss_coefficients.additional_properties = d
        return transmission_loss_coefficients
