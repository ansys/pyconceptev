...
T = TypeVar("T", bound="MotorTorqueCurvesOutput")


@_attrs_define
class MotorTorqueCurvesOutput:
    """Motor Torque Curves Output."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if component_type != "MotorTorqueCurves" and not isinstance(component_type, Unset):
            raise ValueError(
                f"component_type must match const 'MotorTorqueCurves', got '{component_type}'"
            )
        ...
        motor_torque_curves_output = cls(
            id=id,
            torque_curves_data_id=torque_curves_data_id,
            item_type=item_type,
            name=name,
        ...
        motor_torque_curves_output.additional_properties = d
        return motor_torque_curves_output
