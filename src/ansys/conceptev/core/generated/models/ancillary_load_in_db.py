...
T = TypeVar("T", bound="AncillaryLoadInDB")


@_attrs_define
class AncillaryLoadInDB:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ancillary_load_in_db.additional_properties = d
        return ancillary_load_in_db
