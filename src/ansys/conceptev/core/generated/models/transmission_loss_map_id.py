...
T = TypeVar("T", bound="TransmissionLossMapID")


@_attrs_define
class TransmissionLossMapID:
    ...
    component_type: Literal["TransmissionLossMapID"] | Unset = "TransmissionLossMapID"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        component_type = cast(Literal["TransmissionLossMapID"] | Unset, d.pop("component_type", UNSET))
        if component_type != "TransmissionLossMapID" and not isinstance(component_type, Unset):
            raise ValueError(f"component_type must match const 'TransmissionLossMapID', got '{component_type}'")

        transmission_loss_map_id = cls(
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        transmission_loss_map_id.additional_properties = d
        return transmission_loss_map_id
