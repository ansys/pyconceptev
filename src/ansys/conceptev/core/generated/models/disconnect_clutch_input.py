...
T = TypeVar("T", bound="DisconnectClutchInput")


@_attrs_define
class DisconnectClutchInput:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if component_type != "ClutchInput" and not isinstance(component_type, Unset):
            raise ValueError(
                f"component_type must match const 'ClutchInput', got '{component_type}'"
            )
        ...
        disconnect_clutch_input.additional_properties = d
        return disconnect_clutch_input
