...
T = TypeVar("T", bound="InverterMOSFETData")


@_attrs_define
class InverterMOSFETData:
    """Wrapper for inverter MOSFET model to handle units and defaults."""

    modulation_index: float | Unset = 1.12
    dc_harness_resistance: float | Unset = 0.01
    ac_harness_resistance: float | Unset = 0.001
    switching_energy_on: float | Unset = 0.021
    switching_energy_off: float | Unset = 0.018
    switching_energy_reverse: float | Unset = 0.004
    ...
    diode_voltage_drop: float | Unset = 2.1
    diode_dynamic_resistance: float | Unset = 0.0018
    drain_source_on_resistance: float | Unset = 0.0018
    inverter_type: Literal["MOSFET"] | Unset = "MOSFET"
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        drain_source_on_resistance = self.drain_source_on_resistance
        ...
        if drain_source_on_resistance is not UNSET:
            field_dict["drain_source_on_resistance"] = drain_source_on_resistance
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drain_source_on_resistance = d.pop("drain_source_on_resistance", UNSET)

        inverter_type = cast(Literal["MOSFET"] | Unset, d.pop("inverter_type", UNSET))
        if inverter_type != "MOSFET" and not isinstance(inverter_type, Unset):
            raise ValueError(f"inverter_type must match const 'MOSFET', got '{inverter_type}'")

        inverter_mosfet_data = cls(
            ...
            drain_source_on_resistance=drain_source_on_resistance,
            inverter_type=inverter_type,
        )

        inverter_mosfet_data.additional_properties = d
        return inverter_mosfet_data
