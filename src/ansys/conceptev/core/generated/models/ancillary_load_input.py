...
T = TypeVar("T", bound="AncillaryLoadInput")


@_attrs_define
class AncillaryLoadInput:
    """Ancillary Load Input."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ancillary_load_input.additional_properties = d
        return ancillary_load_input
