...
T = TypeVar("T", bound="AncillaryLoadOutput")


@_attrs_define
class AncillaryLoadOutput:
    """Ancillary Load Output."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ancillary_load_output.additional_properties = d
        return ancillary_load_output
