...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ConceptSettings.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Get Design Instance Settings

     Retrieve Concept settings, falling back to defaults if missing or incomplete.
