...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/drive_cycles/{item_id}".format(
...
) -> Any | DriveCycleInDB | DriveCycleS3 | HTTPValidationError | None:
    if response.status_code == 200:

        def _parse_response_200(data: object) -> DriveCycleInDB | DriveCycleS3:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_type_0 = DriveCycleInDB.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            response_200_type_1 = DriveCycleS3.from_dict(data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | DriveCycleInDB | DriveCycleS3 | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | DriveCycleInDB | DriveCycleS3 | HTTPValidationError
    """
