...
T = TypeVar("T", bound="SolvedTransmission")


@_attrs_define
class SolvedTransmission:
    """Solved transmission node."""
    ...
    solved_component_type: Literal["transmission"] | Unset = "transmission"
    gear_ratios_optimal: list[float] | Unset = UNSET
    losses_torque: list[float] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        in_speeds = self.in_speeds

        out_speeds = self.out_speeds
        ...
        gear_ratios_optimal: list[float] | Unset = UNSET
        if not isinstance(self.gear_ratios_optimal, Unset):
            gear_ratios_optimal = self.gear_ratios_optimal

        losses_torque: list[float] | Unset = UNSET
        if not isinstance(self.losses_torque, Unset):
            losses_torque = self.losses_torque
        ...
        if gear_ratios_optimal is not UNSET:
            field_dict["gear_ratios_optimal"] = gear_ratios_optimal
        if losses_torque is not UNSET:
            field_dict["losses_torque"] = losses_torque
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        in_speeds = cast(list[float], d.pop("in_speeds"))

        out_speeds = cast(list[float], d.pop("out_speeds"))
        ...
        solved_component_type = cast(Literal["transmission"] | Unset, d.pop("solved_component_type", UNSET))
        if solved_component_type != "transmission" and not isinstance(solved_component_type, Unset):
            raise ValueError(f"solved_component_type must match const 'transmission', got '{solved_component_type}'")

        gear_ratios_optimal = cast(list[float], d.pop("gear_ratios_optimal", UNSET))

        losses_torque = cast(list[float], d.pop("losses_torque", UNSET))

        solved_transmission = cls(
            name=name,
            in_powers=in_powers,
            out_powers=out_powers,
            losses=losses,
            ...
            gear_ratios_optimal=gear_ratios_optimal,
            losses_torque=losses_torque,
        )

        solved_transmission.additional_properties = d
