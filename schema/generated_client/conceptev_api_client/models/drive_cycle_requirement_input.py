...
T = TypeVar("T", bound="DriveCycleRequirementInput")


@_attrs_define
class DriveCycleRequirementInput:
    """Drive Cycle Requirement Input."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drive_cycle_requirement_input = cls(
            aero_id=aero_id,
            mass_id=mass_id,
            wheel_id=wheel_id,
            drive_cycle_id=drive_cycle_id,
        ...
        drive_cycle_requirement_input.additional_properties = d
        return drive_cycle_requirement_input
