...
T = TypeVar("T", bound="MotorTorqueCurvesDataInDB")


@_attrs_define
class MotorTorqueCurvesDataInDB:
    """Torque curves in Database."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        motor_torque_curves_data_in_db = cls(
            speeds=speeds,
            torques=torques,
            voltages=voltages,
        ...
        motor_torque_curves_data_in_db.additional_properties = d
