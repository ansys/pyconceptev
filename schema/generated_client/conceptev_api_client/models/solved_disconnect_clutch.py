...
T = TypeVar("T", bound="SolvedDisconnectClutch")


@_attrs_define
class SolvedDisconnectClutch:
    """Solved clutch."""
    ...
    solved_component_type: Literal["clutch"] | Unset = "clutch"
    disconnected: list[bool] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        disconnected: list[bool] | Unset = UNSET
        if not isinstance(self.disconnected, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solved_component_type = cast(Literal["clutch"] | Unset, d.pop("solved_component_type", UNSET))
        if solved_component_type != "clutch" and not isinstance(solved_component_type, Unset):
            raise ValueError(f"solved_component_type must match const 'clutch', got '{solved_component_type}'")

        disconnected = cast(list[bool], d.pop("disconnected", UNSET))

        solved_disconnect_clutch = cls(
            name=name,
            in_powers=in_powers,
            out_powers=out_powers,
            losses=losses,
        ...
        solved_disconnect_clutch.additional_properties = d
