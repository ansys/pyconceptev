...
if TYPE_CHECKING:
    ...
    from ..models.drive_cycle_requirement import DriveCycleRequirement
    from ..models.drive_cycle_solved_energy_axle_split import DriveCycleSolvedEnergyAxleSplit
    from ..models.drive_cycle_solved_warnings import DriveCycleSolvedWarnings
...
T = TypeVar("T", bound="DriveCycleSolved")


@_attrs_define
class DriveCycleSolved:
    """Solution to Drive Cycle given to APP."""
    ...
    time: list[float]
    distance: list[float]
    drive_cycle_requirement: DriveCycleRequirement
    """ Drive Cycle Requirement Populated From Database. """
    torques_achieved: list[float]
    torques_drive_cycle: list[float]
    ...
    energy_axle_split: DriveCycleSolvedEnergyAxleSplit | Unset = UNSET
    ...
    requirement_solved_type: Literal["drive_cycle"] | Unset = "drive_cycle"
    points_achieved_ratio: float | Unset = 1.0
    points_not_achieved: list[int] | Unset = UNSET
    warnings: DriveCycleSolvedWarnings | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        drive_cycle_requirement = self.drive_cycle_requirement.to_dict()

        torques_achieved = self.torques_achieved

        torques_drive_cycle = self.torques_drive_cycle
        ...
        points_achieved_ratio = self.points_achieved_ratio

        points_not_achieved: list[int] | Unset = UNSET
        if not isinstance(self.points_not_achieved, Unset):
            points_not_achieved = self.points_not_achieved
        ...
        field_dict.update(
            {
                ...
                "time": time,
                "distance": distance,
                "drive_cycle_requirement": drive_cycle_requirement,
                "torques_achieved": torques_achieved,
                "torques_drive_cycle": torques_drive_cycle,
            }
        )
        ...
        if points_achieved_ratio is not UNSET:
            field_dict["points_achieved_ratio"] = points_achieved_ratio
        if points_not_achieved is not UNSET:
            field_dict["points_not_achieved"] = points_not_achieved
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drive_cycle_requirement = DriveCycleRequirement.from_dict(d.pop("drive_cycle_requirement"))

        torques_achieved = cast(list[float], d.pop("torques_achieved"))

        torques_drive_cycle = cast(list[float], d.pop("torques_drive_cycle"))
        ...
        energy_axle_split: DriveCycleSolvedEnergyAxleSplit | Unset
        if isinstance(_energy_axle_split, Unset):
            energy_axle_split = UNSET
        else:
            energy_axle_split = DriveCycleSolvedEnergyAxleSplit.from_dict(_energy_axle_split)
        ...
        requirement_solved_type = cast(Literal["drive_cycle"] | Unset, d.pop("requirement_solved_type", UNSET))
        if requirement_solved_type != "drive_cycle" and not isinstance(requirement_solved_type, Unset):
            raise ValueError(f"requirement_solved_type must match const 'drive_cycle', got '{requirement_solved_type}'")

        points_achieved_ratio = d.pop("points_achieved_ratio", UNSET)

        points_not_achieved = cast(list[int], d.pop("points_not_achieved", UNSET))

        _warnings = d.pop("warnings", UNSET)
        warnings: DriveCycleSolvedWarnings | Unset
        if isinstance(_warnings, Unset):
            warnings = UNSET
        else:
            warnings = DriveCycleSolvedWarnings.from_dict(_warnings)

        drive_cycle_solved = cls(
            feasible=feasible,
            solved_components=solved_components,
            time=time,
            distance=distance,
            ...
            points_achieved_ratio=points_achieved_ratio,
            points_not_achieved=points_not_achieved,
            warnings=warnings,
        )

        drive_cycle_solved.additional_properties = d
