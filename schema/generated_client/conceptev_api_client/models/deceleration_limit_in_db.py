...
T = TypeVar("T", bound="DecelerationLimitInDB")


@_attrs_define
class DecelerationLimitInDB:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deceleration_limit_in_db.additional_properties = d
        return deceleration_limit_in_db
