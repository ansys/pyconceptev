...
T = TypeVar("T", bound="BatteryLookupTableInDB")


@_attrs_define
class BatteryLookupTableInDB:
    """Battery in Database."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        battery_lookup_table_in_db = cls(
            lookup_table=lookup_table,
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        battery_lookup_table_in_db.additional_properties = d
        return battery_lookup_table_in_db
