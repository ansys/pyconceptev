...
T = TypeVar("T", bound="BatteryFixedVoltages")


@_attrs_define
class BatteryFixedVoltages:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        battery_fixed_voltages.additional_properties = d
        return battery_fixed_voltages
