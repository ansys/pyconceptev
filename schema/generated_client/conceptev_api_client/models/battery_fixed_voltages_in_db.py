...
T = TypeVar("T", bound="BatteryFixedVoltagesInDB")


@_attrs_define
class BatteryFixedVoltagesInDB:
    """Battery in Database."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        battery_fixed_voltages_in_db = cls(
            item_type=item_type,
            name=name,
            mass=mass,
        ...
        battery_fixed_voltages_in_db.additional_properties = d
        return battery_fixed_voltages_in_db
